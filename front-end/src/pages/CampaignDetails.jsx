    ...
    <div>
      ...
      <div className={`mt-[60px] gap-5 flex lg:flex-row flex-col`}>
          ...
          <div>
            ...
            <div className="mt-[20px] flex flex-row items-center flex-wrap gap-[14px]">
              ...
              <div>
                ...
                <p
                  className={`font-epilogue font-normal text-[12px] text-[#808191] p-3`}
                >
                  10 Campaigns
                </p>
              </div>
            ...
            <div className="mt-[20px] flex flex-row items-center flex-wrap gap-4">
              {donators.length > 0 ? (
                donators.map((item, index) => (
                  ...
                  >
                    <p
                      className={`font-epilogue font-normal text-[12px] text-[#b2b3bd] leading-[26px]`}
                    >
                      {index + 1}. {item.donator}
                    </p>
                    <p
                      className={`font-epilogue font-normal text-[12px] text-[#808191] leading-[26px]`}
                    >
                      {item.donation}
                    </p>
                  </div>
        ...
        <div className={`flex-1`}>
          ...
          <div
            className={`my-[20px] flex flex-col p-4 bg-[#1c1c24] rounded-[10px]`}
          >
            <p
              className={`font-epilogue font-medium text-center text-[20px] leading-[30px] text-[#808191]`}
            >
              Fund the campaign
            </p>
